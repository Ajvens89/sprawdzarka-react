...
export function OrdersCart() {
  ...
  const lastSubmitError = useOrdersStore((s) => s.lastSubmitError);
  ...
  const clearSubmitError = useOrdersStore((s) => s.clearSubmitError);
    ...
    <div className="orders-cart">
      ...
      {isEmpty ? (
        ...
        <>
            ...
            {cartItems.map((item) => (
              <li key={item.id} className="cart-item">
                ...
                <div className="cart-item-controls">
                  ...
                  <button className="qty-btn" onClick={() => incrementItem(item.id)}>
                    +
                  </button>
                ...
                <span className="cart-item-total">{formatPrice(item.qty * item.unitPrice)}</span>
              </li>
            ))}
          </ul>
          ...
          {lastSubmitError ? <div className="cart-error">{lastSubmitError}</div> : null}
